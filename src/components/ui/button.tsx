...
export const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className = '', variant = 'default', size = 'md', children, disabled, ...props }, ref) => {
    const baseStyle =
      'inline-flex items-center justify-center font-medium transition-saas focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#0A2030]/20 disabled:pointer-events-none disabled:opacity-50 select-none rounded-xl cursor-pointer active:scale-[0.99]';

    const variantStyles = {
      default: 'bg-[#0A2030] text-white hover:bg-[#071520] active:bg-[#040D14] shadow-saas border border-transparent',
      ...
      link: 'text-[#0A2030] underline-offset-4 hover:underline p-0 h-auto font-normal',
    };
